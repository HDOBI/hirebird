...
function Subscribe() {
  ...
  return (
    <div className="flex flex-col p-8 items-center justify-center max-w-[440px] shadow-priceBox mx-3 sm:mx-auto text-center mt-4 sm:mt-6 px-3 md:px-0 rounded-[20px] overflow-x-hidden">
